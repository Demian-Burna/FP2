...
if 'DATABASE_URL' in os.environ:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='finance_manager'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'finance_manager.auth.SupabaseAuthentication',
    ],
...
EXCHANGE_API_KEY = config('EXCHANGE_API_KEY', default='')
EXCHANGE_BASE_URL = config('EXCHANGE_BASE_URL', default='https://api.exchangeratesapi.io/v1/')
